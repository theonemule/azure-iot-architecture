...
var provisioningClient = ProvisioningDeviceClient.create(settings.provisioningHost, settings.idScope, new ProvisioningTransport(), provisioningSecurityClient);
